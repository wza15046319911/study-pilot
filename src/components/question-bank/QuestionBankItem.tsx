    ...
    <div onClick={handleCardClick} className="cursor-pointer h-full">
      ...
      >
        ...
        <div className="w-full flex justify-between items-start">
          ...
          {badgeText && (
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 mb-4">
              {badgeIcon}
              <span>{badgeText}</span>
            </div>
          )}
        ...
        <div className="w-full">
          <h3 className="font-bold text-xl text-left text-slate-900 dark:text-white mb-4 leading-tight">
            {title}
          </h3>
          <p className="text-sm text-left text-slate-500 dark:text-slate-400 leading-relaxed line-clamp-3 p">
            {description}
          </p>
        </div>
