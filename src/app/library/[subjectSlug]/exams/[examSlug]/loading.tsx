...
export default function LoadingExamPreview() {
  return (
      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-4">
            <div className="h-[500px] animate-pulse rounded-3xl border border-slate-200/70 bg-white/70 p-8 dark:border-slate-800 dark:bg-slate-900/70" />
          </div>
          ...
          <div className="space-y-6 lg:col-span-8">
            ...
            <div className="h-56 animate-pulse rounded-2xl border border-slate-200/70 bg-white/70 dark:border-slate-800 dark:bg-slate-900/70" />
            <div className="h-72 animate-pulse rounded-2xl border border-slate-200/70 bg-white/70 dark:border-slate-800 dark:bg-slate-900/70" />
          </div>
        </div>
      </main>
    </div>
