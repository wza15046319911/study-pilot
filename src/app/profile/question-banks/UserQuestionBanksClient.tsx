...
import { Library, ChevronRight, Trophy, Clock, Search } from "lucide-react";
              ...
              <div className="mt-auto pt-4 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 border-t border-gray-100 dark:border-gray-800">
                ...
                {item.last_completed_at && (
                  <div
                    ...
                    title={new Date(item.last_completed_at).toLocaleString()}
                  >
                    <Clock className="size-3.5" />
                    <span>
                      {formatDistanceToNow(new Date(item.last_completed_at), {
                        addSuffix: true,
                      })}
                    </span>
                  </div>
