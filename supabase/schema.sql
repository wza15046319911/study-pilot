...
ALTER TABLE "public"."distribution_users" OWNER TO "postgres";


ALTER TABLE "public"."distribution_users" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."distribution_users_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."distributions" (
    ...
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "distributions_target_type_check" CHECK (("target_type" = ANY (ARRAY['question_bank'::"text", 'exam'::"text"]))),
    CONSTRAINT "distributions_visibility_check" CHECK (("visibility" = ANY (ARRAY['public'::"text", 'assigned_only'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."exams" (
    ...
    "unlock_type" "text" DEFAULT 'free'::"text" NOT NULL,
    "price" numeric,
    "allowed_modes" "text"[] DEFAULT ARRAY['exam'::"text"] NOT NULL,
    "visibility" "text" DEFAULT 'public'::"text",
    CONSTRAINT "exams_exam_type_check" CHECK (("exam_type" = ANY (ARRAY['midterm'::"text", 'final'::"text"]))),
    CONSTRAINT "exams_visibility_check" CHECK (("visibility" = ANY (ARRAY['public'::"text", 'assigned_only'::"text"])))
);
...
CREATE SEQUENCE IF NOT EXISTS "public"."homework_assignments_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."homework_assignments_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."homework_items" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."homework_items_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."homework_items_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."homework_items_id_seq" OWNED BY "public"."homework_items"."id";
...
CREATE SEQUENCE IF NOT EXISTS "public"."homework_submissions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."homeworks" (
    ...
    "allowed_modes" "text"[] DEFAULT ARRAY['standard'::"text", 'immersive'::"text", 'flashcard'::"text"] NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS "public"."homeworks_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."past_exam_questions" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."past_exam_questions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."past_exam_questions_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."past_exam_questions_id_seq" OWNED BY "public"."past_exam_questions"."id";
...
ALTER TABLE "public"."past_exams" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."past_exams_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."past_exams_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."past_exams_id_seq" OWNED BY "public"."past_exams"."id";
...
CREATE TABLE IF NOT EXISTS "public"."question_banks" (
    ...
    CONSTRAINT "question_banks_visibility_check" CHECK (("visibility" = ANY (ARRAY['public'::"text", 'assigned_only'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."questions" (
    ...
    "tags" json,
    "test_cases" "jsonb",
    CONSTRAINT "questions_coding_challenge_requirements" CHECK ((("type" <> 'coding_challenge'::"text") OR (("answer" = 'all_tests_passed'::"text") AND ("test_cases" IS NOT NULL) AND ("jsonb_typeof"("test_cases") = 'object'::"text") AND (NULLIF("btrim"(("test_cases" ->> 'function_name'::"text")), ''::"text") IS NOT NULL) AND ("jsonb_typeof"(("test_cases" -> 'test_cases'::"text")) = 'array'::"text") AND ("jsonb_array_length"(("test_cases" -> 'test_cases'::"text")) > 0)))),
    CONSTRAINT "questions_difficulty_check" CHECK (("difficulty" = ANY (ARRAY['easy'::"text", 'medium'::"text", 'hard'::"text"]))),
    CONSTRAINT "questions_type_check" CHECK (("type" = ANY (ARRAY['single_choice'::"text", 'multiple_choice'::"text", 'fill_blank'::"text", 'code_output'::"text", 'handwrite'::"text", 'true_false'::"text", 'coding_challenge'::"text"])))
);
...
COMMENT ON COLUMN "public"."questions"."test_cases" IS 'Test cases for coding_challenge type: {function_name: string, test_cases: [{input: any[], expected: any}]}';
...
CREATE TABLE IF NOT EXISTS "public"."referrals" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "referrer_used_for_unlock" boolean DEFAULT false NOT NULL,
    "referee_used_for_unlock" boolean DEFAULT false NOT NULL,
    "referrer_unlocked_bank_id" bigint,
    "referee_unlocked_bank_id" bigint
);
...
CREATE TABLE IF NOT EXISTS "public"."subject_exam_dates" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "student_level" "text" DEFAULT 'undergraduate'::"text" NOT NULL,
    CONSTRAINT "subject_exam_dates_exam_type_check" CHECK (("exam_type" = ANY (ARRAY['midterm'::"text", 'final'::"text"]))),
    CONSTRAINT "subject_exam_dates_student_level_check" CHECK (("student_level" = ANY (ARRAY['undergraduate'::"text", 'postgraduate'::"text"])))
);


ALTER TABLE "public"."subject_exam_dates" OWNER TO "postgres";


ALTER TABLE "public"."subject_exam_dates" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."subject_exam_dates_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."weekly_practice_items" (
    "id" bigint NOT NULL,
    "weekly_practice_id" bigint NOT NULL,
    "question_id" bigint NOT NULL,
    "order_index" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
ALTER TABLE "public"."weekly_practice_items" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."weekly_practice_items_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."weekly_practice_items_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."weekly_practice_items_id_seq" OWNED BY "public"."weekly_practice_items"."id";
...
ALTER TABLE "public"."weekly_practice_submissions" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."weekly_practice_submissions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."weekly_practice_submissions_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."weekly_practice_submissions_id_seq" OWNED BY "public"."weekly_practice_submissions"."id";
...
CREATE TABLE IF NOT EXISTS "public"."weekly_practices" (
    ...
    "week_start" "date",
    "is_published" boolean DEFAULT false NOT NULL,
    "allowed_modes" "text"[] DEFAULT ARRAY['standard'::"text"] NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."weekly_practices" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."weekly_practices_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."weekly_practices_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."weekly_practices_id_seq" OWNED BY "public"."weekly_practices"."id";
...
ALTER TABLE ONLY "public"."homework_items" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."homework_items_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."past_exam_questions" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."past_exam_questions_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."past_exams" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."past_exams_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."weekly_practice_items" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."weekly_practice_items_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."weekly_practice_submissions" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."weekly_practice_submissions_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."weekly_practices" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."weekly_practices_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."distribution_users"
    ADD CONSTRAINT "distribution_users_distribution_id_user_id_key" UNIQUE ("distribution_id", "user_id");



ALTER TABLE ONLY "public"."distribution_users"
    ADD CONSTRAINT "distribution_users_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."homework_assignments"
    ADD CONSTRAINT "homework_assignments_homework_id_user_id_key" UNIQUE ("homework_id", "user_id");
...
ALTER TABLE ONLY "public"."homework_items"
    ADD CONSTRAINT "homework_items_homework_id_question_id_key" UNIQUE ("homework_id", "question_id");
...
ALTER TABLE ONLY "public"."homeworks"
    ADD CONSTRAINT "homeworks_slug_key" UNIQUE ("slug");
...
ALTER TABLE ONLY "public"."past_exam_questions"
    ADD CONSTRAINT "past_exam_questions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."past_exams"
    ADD CONSTRAINT "past_exams_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."subject_exam_dates"
    ADD CONSTRAINT "subject_exam_dates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."subject_exam_dates"
    ADD CONSTRAINT "subject_exam_dates_subject_id_exam_type_student_level_key" UNIQUE ("subject_id", "exam_type", "student_level");
...
ALTER TABLE ONLY "public"."weekly_practice_items"
    ADD CONSTRAINT "weekly_practice_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."weekly_practice_items"
    ADD CONSTRAINT "weekly_practice_items_weekly_practice_id_question_id_key" UNIQUE ("weekly_practice_id", "question_id");



ALTER TABLE ONLY "public"."weekly_practice_submissions"
    ADD CONSTRAINT "weekly_practice_submissions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."weekly_practices"
    ADD CONSTRAINT "weekly_practices_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."weekly_practices"
    ADD CONSTRAINT "weekly_practices_slug_key" UNIQUE ("slug");



CREATE INDEX "homework_assignments_homework_id_idx" ON "public"."homework_assignments" USING "btree" ("homework_id");



CREATE INDEX "homework_assignments_user_id_idx" ON "public"."homework_assignments" USING "btree" ("user_id");



CREATE INDEX "homework_items_homework_id_idx" ON "public"."homework_items" USING "btree" ("homework_id");



CREATE INDEX "homework_submissions_homework_id_idx" ON "public"."homework_submissions" USING "btree" ("homework_id");



CREATE INDEX "homework_submissions_user_id_idx" ON "public"."homework_submissions" USING "btree" ("user_id");



CREATE INDEX "homeworks_due_at_idx" ON "public"."homeworks" USING "btree" ("due_at");



CREATE INDEX "homeworks_subject_id_idx" ON "public"."homeworks" USING "btree" ("subject_id");



CREATE INDEX "idx_distribution_users_dist" ON "public"."distribution_users" USING "btree" ("distribution_id");



CREATE INDEX "idx_distribution_users_user" ON "public"."distribution_users" USING "btree" ("user_id");



CREATE INDEX "idx_distributions_target" ON "public"."distributions" USING "btree" ("target_type", "target_id");
...
CREATE INDEX "past_exam_questions_order_idx" ON "public"."past_exam_questions" USING "btree" ("past_exam_id", "order_index");



CREATE INDEX "past_exam_questions_past_exam_id_idx" ON "public"."past_exam_questions" USING "btree" ("past_exam_id");



CREATE INDEX "past_exams_subject_id_idx" ON "public"."past_exams" USING "btree" ("subject_id");



CREATE INDEX "past_exams_subject_year_semester_created_at_idx" ON "public"."past_exams" USING "btree" ("subject_id", "year", "semester", "created_at" DESC);



CREATE INDEX "past_exams_subject_year_semester_idx" ON "public"."past_exams" USING "btree" ("subject_id", "year", "semester");



CREATE INDEX "past_exams_year_idx" ON "public"."past_exams" USING "btree" ("year");



CREATE INDEX "question_bank_items_bank_id_idx" ON "public"."question_bank_items" USING "btree" ("bank_id");



CREATE INDEX "question_bank_items_question_id_idx" ON "public"."question_bank_items" USING "btree" ("question_id");



CREATE INDEX "question_banks_slug_idx" ON "public"."question_banks" USING "btree" ("slug");
...
CREATE INDEX "questions_subject_created_idx" ON "public"."questions" USING "btree" ("subject_id", "created_at" DESC);



CREATE INDEX "questions_title_trgm_idx" ON "public"."questions" USING "gin" ("title" "public"."gin_trgm_ops");
...
CREATE INDEX "questions_type_idx" ON "public"."questions" USING "btree" ("type");



CREATE INDEX "user_bank_unlocks_user_bank_idx" ON "public"."user_bank_unlocks" USING "btree" ("user_id", "bank_id");



CREATE INDEX "user_question_bank_collections_user_bank_idx" ON "public"."user_question_bank_collections" USING "btree" ("user_id", "bank_id");



CREATE INDEX "weekly_practice_items_weekly_practice_id_idx" ON "public"."weekly_practice_items" USING "btree" ("weekly_practice_id");



CREATE INDEX "weekly_practice_submissions_user_id_idx" ON "public"."weekly_practice_submissions" USING "btree" ("user_id");



CREATE INDEX "weekly_practice_submissions_weekly_practice_id_idx" ON "public"."weekly_practice_submissions" USING "btree" ("weekly_practice_id");



CREATE INDEX "weekly_practices_subject_id_idx" ON "public"."weekly_practices" USING "btree" ("subject_id");



CREATE INDEX "weekly_practices_week_start_idx" ON "public"."weekly_practices" USING "btree" ("week_start");
...
ALTER TABLE ONLY "public"."distribution_users"
    ADD CONSTRAINT "distribution_users_distribution_id_fkey" FOREIGN KEY ("distribution_id") REFERENCES "public"."distributions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."distribution_users"
    ADD CONSTRAINT "distribution_users_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."distributions"
    ADD CONSTRAINT "distributions_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."homework_assignments"
    ADD CONSTRAINT "homework_assignments_homework_id_fkey" FOREIGN KEY ("homework_id") REFERENCES "public"."homeworks"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."homework_assignments"
    ADD CONSTRAINT "homework_assignments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."homework_items"
    ADD CONSTRAINT "homework_items_homework_id_fkey" FOREIGN KEY ("homework_id") REFERENCES "public"."homeworks"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."homework_items"
    ADD CONSTRAINT "homework_items_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "public"."questions"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."homework_submissions"
    ADD CONSTRAINT "homework_submissions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."homeworks"
    ADD CONSTRAINT "homeworks_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "public"."subjects"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."past_exam_questions"
    ADD CONSTRAINT "past_exam_questions_past_exam_id_fkey" FOREIGN KEY ("past_exam_id") REFERENCES "public"."past_exams"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."past_exams"
    ADD CONSTRAINT "past_exams_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "public"."subjects"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."referrals"
    ADD CONSTRAINT "referrals_referee_unlocked_bank_id_fkey" FOREIGN KEY ("referee_unlocked_bank_id") REFERENCES "public"."question_banks"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."referrals"
    ADD CONSTRAINT "referrals_referrer_unlocked_bank_id_fkey" FOREIGN KEY ("referrer_unlocked_bank_id") REFERENCES "public"."question_banks"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."subject_exam_dates"
    ADD CONSTRAINT "subject_exam_dates_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "public"."subjects"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_exam_unlocks"
    ADD CONSTRAINT "user_exam_unlocks_exam_id_fkey" FOREIGN KEY ("exam_id") REFERENCES "public"."exams"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_exam_unlocks"
    ADD CONSTRAINT "user_exam_unlocks_referral_id_fkey" FOREIGN KEY ("referral_id") REFERENCES "public"."referrals"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."user_exam_unlocks"
    ADD CONSTRAINT "user_exam_unlocks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."weekly_practice_items"
    ADD CONSTRAINT "weekly_practice_items_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "public"."questions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."weekly_practice_items"
    ADD CONSTRAINT "weekly_practice_items_weekly_practice_id_fkey" FOREIGN KEY ("weekly_practice_id") REFERENCES "public"."weekly_practices"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."weekly_practice_submissions"
    ADD CONSTRAINT "weekly_practice_submissions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."weekly_practice_submissions"
    ADD CONSTRAINT "weekly_practice_submissions_weekly_practice_id_fkey" FOREIGN KEY ("weekly_practice_id") REFERENCES "public"."weekly_practices"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."weekly_practices"
    ADD CONSTRAINT "weekly_practices_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "public"."subjects"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins can manage distribution_users" ON "public"."distribution_users" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."is_admin" = true)))));



CREATE POLICY "Admins can manage distributions" ON "public"."distributions" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."is_admin" = true)))));
...
CREATE POLICY "Admins can manage past exam questions" ON "public"."past_exam_questions" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Admins can manage past exams" ON "public"."past_exams" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Admins can manage subject exam dates" ON "public"."subject_exam_dates" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Anyone can view past exam questions for published past exams" ON "public"."past_exam_questions" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."past_exams"
  WHERE (("past_exams"."id" = "past_exam_questions"."past_exam_id") AND ("past_exams"."is_published" = true)))));
...
CREATE POLICY "Anyone can view published past exams" ON "public"."past_exams" FOR SELECT TO "authenticated" USING (("is_published" = true));
...
CREATE POLICY "Anyone can view subject exam dates" ON "public"."subject_exam_dates" FOR SELECT USING (true);
...
CREATE POLICY "Banks viewable by eligible users" ON "public"."question_banks" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."is_admin" = true)))) OR (("is_published" = true) AND (("visibility" IS NULL) OR ("visibility" = 'public'::"text"))) OR (("is_published" = true) AND ("visibility" = 'assigned_only'::"text") AND (EXISTS ( SELECT 1
   FROM ("public"."distributions" "d"
     JOIN "public"."distribution_users" "du" ON (("du"."distribution_id" = "d"."id")))
  WHERE (("d"."target_type" = 'question_bank'::"text") AND ("d"."target_id" = "question_banks"."id") AND ("du"."user_id" = "auth"."uid"())))))));



CREATE POLICY "Exam questions viewable by eligible users" ON "public"."exam_questions" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."is_admin" = true)))) OR (EXISTS ( SELECT 1
   FROM "public"."exams" "e"
  WHERE (("e"."id" = "exam_questions"."exam_id") AND ((("e"."is_published" = true) AND (("e"."visibility" IS NULL) OR ("e"."visibility" = 'public'::"text"))) OR (("e"."is_published" = true) AND ("e"."visibility" = 'assigned_only'::"text") AND (EXISTS ( SELECT 1
           FROM ("public"."distributions" "d"
             JOIN "public"."distribution_users" "du" ON (("du"."distribution_id" = "d"."id")))
          WHERE (("d"."target_type" = 'exam'::"text") AND ("d"."target_id" = "e"."id") AND ("du"."user_id" = "auth"."uid"())))))))))));



CREATE POLICY "Exams viewable by eligible users" ON "public"."exams" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."is_admin" = true)))) OR (("is_published" = true) AND (("visibility" IS NULL) OR ("visibility" = 'public'::"text"))) OR (("is_published" = true) AND ("visibility" = 'assigned_only'::"text") AND (EXISTS ( SELECT 1
   FROM ("public"."distributions" "d"
     JOIN "public"."distribution_users" "du" ON (("du"."distribution_id" = "d"."id")))
  WHERE (("d"."target_type" = 'exam'::"text") AND ("d"."target_id" = "exams"."id") AND ("du"."user_id" = "auth"."uid"())))))));



CREATE POLICY "Items viewable by eligible users" ON "public"."question_bank_items" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."is_admin" = true)))) OR (EXISTS ( SELECT 1
   FROM "public"."question_banks" "qb"
  WHERE (("qb"."id" = "question_bank_items"."bank_id") AND ((("qb"."is_published" = true) AND (("qb"."visibility" IS NULL) OR ("qb"."visibility" = 'public'::"text"))) OR (("qb"."is_published" = true) AND ("qb"."visibility" = 'assigned_only'::"text") AND (EXISTS ( SELECT 1
           FROM ("public"."distributions" "d"
             JOIN "public"."distribution_users" "du" ON (("du"."distribution_id" = "d"."id")))
          WHERE (("d"."target_type" = 'question_bank'::"text") AND ("d"."target_id" = "qb"."id") AND ("du"."user_id" = "auth"."uid"())))))))))));
...
CREATE POLICY "Users can manage their own exam unlocks" ON "public"."user_exam_unlocks" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own distribution entries" ON "public"."distribution_users" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON TABLE "public"."distribution_users" TO "anon";
GRANT ALL ON TABLE "public"."distribution_users" TO "authenticated";
GRANT ALL ON TABLE "public"."distribution_users" TO "service_role";



GRANT ALL ON SEQUENCE "public"."distribution_users_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."distribution_users_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."distribution_users_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."homework_assignments_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."homework_assignments_id_seq" TO "authenticated";
...
GRANT ALL ON SEQUENCE "public"."homework_items_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."homework_items_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."homework_items_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."homework_submissions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."homework_submissions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."homework_submissions_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."homeworks_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."homeworks_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."homeworks_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."subject_exam_dates" TO "anon";
...
GRANT ALL ON SEQUENCE "public"."subject_exam_dates_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."subject_exam_dates_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."subject_exam_dates_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."weekly_practice_items" TO "anon";
GRANT ALL ON TABLE "public"."weekly_practice_items" TO "authenticated";
GRANT ALL ON TABLE "public"."weekly_practice_items" TO "service_role";



GRANT ALL ON SEQUENCE "public"."weekly_practice_items_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."weekly_practice_items_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."weekly_practice_items_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."weekly_practice_submissions" TO "anon";
GRANT ALL ON TABLE "public"."weekly_practice_submissions" TO "authenticated";
GRANT ALL ON TABLE "public"."weekly_practice_submissions" TO "service_role";



GRANT ALL ON SEQUENCE "public"."weekly_practice_submissions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."weekly_practice_submissions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."weekly_practice_submissions_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."weekly_practices" TO "anon";
GRANT ALL ON TABLE "public"."weekly_practices" TO "authenticated";
GRANT ALL ON TABLE "public"."weekly_practices" TO "service_role";



GRANT ALL ON SEQUENCE "public"."weekly_practices_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."weekly_practices_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."weekly_practices_id_seq" TO "service_role";
